...
import com.placesearch.vo.SearchVO;
...
public class PlaceSearchController {
    ...
    public String  makeList(Authentication auth, @RequestBody JSONObject response) {
        ...
        //document
        ArrayList<HashMap<SearchVO,String>> documents = (ArrayList<HashMap<SearchVO, String>>) response.get("documents");
        ...
        System.out.println("mySeacrhHistory == " + mySeacrhHistory);
